...
<body>
    <header>
        <div class="container">
            ...
            <nav>
                <a href="<?php echo e(url('/')); ?>">Főoldal</a>
    ...
    <main>
        ...
        <div id="car_myModal" class="car_modal">
            <div class="car_modal-content">
                ...
                <form action="<?php echo e(route('idopont')); ?>" method="POST">
                <h2>Autó adatok</h2>
                <p>Rendszám tábla:</p>
...
<?php /**PATH C:\Users\krist\Documents\PHP\BOSSERIVCE\resources\views/idopont.blade.php ENDPATH**/ ?>